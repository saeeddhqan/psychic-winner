...
"""
	An Implementation of a modified version PBT. Here's how it works: We create n independent models
...
# Create a dir for saving individuals and remove it if it exists
...
# Training, evaluating, mutating and repeating
for generation in range(generation_size):
	...
	# Mutate moderate performed models, individuals that are neither at the top nor at the bottom.
	pbt_util.usual_suspects(tasks, cutoff, 3, pbt_util.hyperparams, pbt_util.hyperparams_bounds)
	# If there's no model to be trained, break
	if _any is False:
		break
